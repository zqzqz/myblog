    ...
    <div class="row">
        <div class="col-md-3" id="myScrollspy">
            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="125">
                ...
                <li><a href="#section-2">教育状况</a></li>
                <li><a href="#section-3">技能特长</a></li>
                <li><a href="#section-4">相关经历</a></li>
                <li><a href="#section-5">兴趣爱好</a></li>
            </ul>
        </div>
        <div class="col-md-9">
